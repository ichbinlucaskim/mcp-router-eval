...
| [0021](adr/0021-traversal-router-expansion.md) | Traversal router keeps its own dependency expansion (explicit exception), then passes through the shared closure | Accepted |
